...
export default function Edit({ stockItem, existingCategories = [] }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('admin.stocks.update', stockItem.id));
    };
            ...
            header={
                <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-xl font-bold leading-tight text-neutral-800 font-header">
                        Edit Stok: {stockItem.name}
                    </h2>
                </div>
            }
        >
            <Head title={`Edit Stok - ${stockItem.name}`} />
