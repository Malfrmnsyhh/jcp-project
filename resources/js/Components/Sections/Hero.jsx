...
export default function Hero({ title, subtitle }) {
    return (
        <section className="bg-primary-600 w-full flex flex-col items-center justify-center text-center px-6 py-24 sm:py-32 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
                <span className="px-3 py-1 mb-6 rounded-full text-xs font-bold bg-primary-700 text-white uppercase tracking-wider border border-primary-500 shadow-sm">
                    Layanan Profesional JCP
                </span>
